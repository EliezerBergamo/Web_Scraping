...
class Estrategia:
    def __init__(self, segmento='', cotacao_atual_minima=0, ffo_yield_minimo=0, dividend_yield_minimo=0,
                 ...
                 valor_minimo_preco_m2=0, valor_minimo_alugel_m2=0, valor_minimo_cap_rate=0,
        ...
        self.valor_minimo_alugel_m2 = valor_minimo_alugel_m2
        self.valor_minimo_cap_rate = valor_minimo_cap_rate
        self.maxima_vacancia_media = maxima_vacancia_media

    def aplica_estrategia(self, fundo: FundoImobilario):
        if self.segmento != '':
            if fundo.segmento != self.segmento:
                return False

        if fundo.cotacao < self.cotacao_atual_minima \
                ...
                or fundo.alugel_m2 < self.valor_minimo_alugel_m2 \
